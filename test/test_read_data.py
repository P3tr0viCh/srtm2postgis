...
from utils import getLatLonFromFileName
...
class TestDatabase(unittest.TestCase):
    def setUp(self):
        self.db_pg = read_data.DatabasePg(
            test_database_connection.db,
            test_database_connection.db_user,
            test_database_connection.db_pass,
        )
        # Drop all tables
        self.db_pg.dropAllTables()

        self.db_psycopg2 = read_data.DatabasePsycopg2(
            test_database_connection.db,
            test_database_connection.db_user,
            test_database_connection.db_pass,
        )
